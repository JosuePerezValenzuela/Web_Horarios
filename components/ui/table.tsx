...
function Table({
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full overflow-hidden rounded-xl border border-border/50 shadow-sm",
        containerClassName
      )}
    >
      <table
...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn(
        "bg-muted/50 border-b-2 border-border/80 [&_tr]:border-b-2 [&_tr]:border-border/80",
        className
      )}
      {...props}
    />
